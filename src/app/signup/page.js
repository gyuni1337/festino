...
export default function Page() {
  ...
  try {
      ...
      if(username === "" || fullName === "" || email === "" || password == "") throw new Error("Fill in everything in the form first.");
        ...
        <div className="min-h-screen bg-[#141313]">
            ...
            <div className="flex justify-center items-center px-4 py-24">
                            ...
                            <div className="space-y-5">
                                <div className="space-y-2">
                                    ...
                                    />
                                                ...
                                                <div className="space-y-2">
                                    <label className="text-xl text-white font-normal" aria-required>Full Name</label>
                                    <input
                                        type="text"
                                ...
                                <div className="space-y-2">
                                    <label className="text-xl text-[#969696] font-normal" aria-required>Password</label>
                                    <input
                                        type="password"
                                ...
                                <div className="space-y-2">
                                    <label className="text-xl text-[#969696] font-normal" aria-required>Confirm password</label>
                                    <input
                                        type="password"
                                        className="w-[329px] h-[38px] border-2 border-white rounded-[14px] px-4 text-lg bg-transparent"
                                        placeholder="Begin typing here.."
                ...
                <h2 className="text-red-500 text-sm">{error}</h2>
                            ...
                            setError("Registrated successfully!")
                            router.push("/");
